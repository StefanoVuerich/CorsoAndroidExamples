...
void Java_com_example_mynativeaudiore_MainActivity_createEngine(JNIEnv* env, jclass clazz)
{
	__android_log_print(ANDROID_LOG_DEBUG, "MainActivity.C", "Create Engine");
    SLresult result;

    // create engine
    result = slCreateEngine(&engineObject, 0, NULL, 0, NULL, NULL);
    assert(SL_RESULT_SUCCESS == result);
    __android_log_print(ANDROID_LOG_DEBUG, "MainActivity.C", "Engine Created");
    (void)result;
...
void Java_com_example_mynativeaudiore_MainActivity_createBufferQueueAudioPlayer(JNIEnv* env,
        jclass clazz)
{
    SLresult result;
...
jboolean Java_com_example_mynativeaudiore_MainActivity_createUriAudioPlayer(JNIEnv* env, jclass clazz,
        jstring uri)
{
    SLresult result;
...
void Java_com_example_mynativeaudiore_MainActivity_setPlayingUriAudioPlayer(JNIEnv* env,
...
void Java_com_example_mynativeaudiore_MainActivity_setLoopingUriAudioPlayer(JNIEnv* env,
...
void Java_com_example_mynativeaudiore_MainActivity_setChannelMuteUriAudioPlayer(JNIEnv* env,
...
void Java_com_example_mynativeaudiore_MainActivity_setChannelSoloUriAudioPlayer(JNIEnv* env,
...
int Java_com_example_mynativeaudiore_MainActivity_getNumChannelsUriAudioPlayer(JNIEnv* env, jclass clazz)
{
	__android_log_print(ANDROID_LOG_DEBUG, "MainActivity.C", "Get Num Channels");
...
void Java_com_example_mynativeaudiore_MainActivity_setVolumeUriAudioPlayer(JNIEnv* env, jclass clazz,
        jint millibel)
{
    SLresult result;
...
void Java_com_example_mynativeaudiore_MainActivity_setMuteUriAudioPlayer(JNIEnv* env, jclass clazz,
        jboolean mute)
{
    SLresult result;
    SLVolumeItf volumeItf = getVolume();
...
void Java_com_example_mynativeaudiore_MainActivity_enableStereoPositionUriAudioPlayer(JNIEnv* env,
...
void Java_com_example_mynativeaudiore_MainActivity_setStereoPositionUriAudioPlayer(JNIEnv* env,
...
jboolean Java_com_example_mynativeaudiore_MainActivity_enableReverb(JNIEnv* env, jclass clazz,
        jboolean enabled)
{
    SLresult result;
...
jboolean Java_com_example_mynativeaudiore_MainActivity_selectClip(JNIEnv* env, jclass clazz, jint which,
        jint count)
{
    switch (which) {
    case 0:     // CLIP_NONE
...
jboolean Java_com_example_mynativeaudiore_MainActivity_createAssetAudioPlayer(JNIEnv* env, jclass clazz,
...
void Java_com_example_mynativeaudiore_MainActivity_setPlayingAssetAudioPlayer(JNIEnv* env,
        jclass clazz, jboolean isPlaying)
{
    SLresult result;
...
jboolean Java_com_example_mynativeaudiore_MainActivity_createAudioRecorder(JNIEnv* env, jclass clazz)
{
    SLresult result;
...
void Java_com_example_mynativeaudiore_MainActivity_startRecording(JNIEnv* env, jclass clazz)
{
    SLresult result;
...
void Java_com_example_mynativeaudiore_MainActivity_shutdown(JNIEnv* env, jclass clazz)
{
