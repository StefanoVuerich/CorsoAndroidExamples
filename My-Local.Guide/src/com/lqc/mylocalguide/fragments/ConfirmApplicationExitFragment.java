...
public class ConfirmApplicationExitFragment extends DialogFragment{
	...
	public final static String _TAG = ConfirmApplicationExitFragment.class.getSimpleName();

	private IOnApplicationExit mCallback;
	...
	public void onAttach(Activity activity) {
		...
		if (activity instanceof IOnApplicationExit) {
			mCallback = (IOnApplicationExit) activity;
		}
	}
